 ...
 * Text Domain: import-export-advanced-custom-fields
 */
...
function acf_import_export_admin_notice() {
    ...
    <div class="notice notice-error">
        <p><?php esc_html_e('ACF Import Export requires Advanced Custom Fields to be installed and activated.', 'import-export-advanced-custom-fields'); ?></p>
    </div>
    <?php
}
